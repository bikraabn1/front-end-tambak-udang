...
import PotentialOfHydrogenDetails from "../pages/PotentialOfHydrogenDetails";
import MainLayout from "../layout/MainLayout";
import SalinityDetails from "../pages/SalinityDetails";
import TemperatureDetails from "../pages/TemperatureDetails";
import TotalDissolvedSolidDetails from "../pages/TotalDissolvedSolidDetails";
